...
class Level3(Level):
    ...
    def __init__(self,gameObj):
        ...
        self._addEnemy( enemy.BoyRobot2(15000,SCREEN_HEIGHT-105, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot3(14200,SCREEN_HEIGHT-320, PLATFORM) )
        self._addNode( levelobject.Node(15418,SCREEN_HEIGHT-116) )
        self._addEnemy( enemy.BoyRobot3(15500,SCREEN_HEIGHT-126, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot3(16000,SCREEN_HEIGHT-105, PLATFORM) )
