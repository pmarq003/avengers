...
class Level3(Level):
    ...
    def __init__(self,gameObj):
        ...
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(8190,SCREEN_HEIGHT-505) )
        ...
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(8595,SCREEN_HEIGHT-505) )
        
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(8749,SCREEN_HEIGHT-505) )
        ...
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(9155,SCREEN_HEIGHT-505) )
        
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(9308,SCREEN_HEIGHT-505) )
        ...
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(9714,SCREEN_HEIGHT-505) )
        
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(9867,SCREEN_HEIGHT-505) )
        ...
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(10273,SCREEN_HEIGHT-505) )
        
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(10426,SCREEN_HEIGHT-505) )
        ...
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(10832,SCREEN_HEIGHT-505) )
        
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(10985,SCREEN_HEIGHT-505) )
        ...
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-55) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-105) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-155) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-205) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-255) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-305) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-355) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-405) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-455) )
        self._addNode( levelobject.Node(11391,SCREEN_HEIGHT-505) )
