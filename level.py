...
class Level3(Level):
    ...
    def __init__(self,gameObj):
        ...
        self._addEnemy( enemy.BoyRobot1(2300,SCREEN_HEIGHT-105, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(3400,SCREEN_HEIGHT-168, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(4300,SCREEN_HEIGHT-135, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(5000,SCREEN_HEIGHT-190, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(5500,SCREEN_HEIGHT-320, PLATFORM) )
        self._addEnemy( enemy.BoyRobot1(5660,SCREEN_HEIGHT-320, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(6200,SCREEN_HEIGHT-190, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(6825,SCREEN_HEIGHT-320, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(7200,SCREEN_HEIGHT-190, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(7700,SCREEN_HEIGHT-74, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(8400,SCREEN_HEIGHT-520, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(9600,SCREEN_HEIGHT-520, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(10100,SCREEN_HEIGHT-520, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(10650,SCREEN_HEIGHT-520, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(11250,SCREEN_HEIGHT-290, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(11600,SCREEN_HEIGHT-105, PLATFORM) )
        self._addEnemy( enemy.BoyRobot1(11700,SCREEN_HEIGHT-105, PLATFORM) )
        self._addEnemy( enemy.BoyRobot1(11800,SCREEN_HEIGHT-105, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(13700,SCREEN_HEIGHT-105, PLATFORM) )
        self._addNode( levelobject.Node(14185,SCREEN_HEIGHT-85) )
        self._addEnemy( enemy.BoyRobot1(14600,SCREEN_HEIGHT-105, PLATFORM) )
        self._addEnemy( enemy.BoyRobot1(14800,SCREEN_HEIGHT-105, PLATFORM) )
        self._addTerrain( levelobject.MegamanPlatLong(13567,SCREEN_HEIGHT-65) )
        self._addNode( levelobject.Node(14803,SCREEN_HEIGHT-85) )
        self._addEnemy( enemy.BoyRobot1(15000,SCREEN_HEIGHT-105, PLATFORM) )
        self._addNode( levelobject.Node(15420,SCREEN_HEIGHT-85) )
        self._addNode( levelobject.Node(13985,SCREEN_HEIGHT-240) )
        self._addEnemy( enemy.BoyRobot1(14200,SCREEN_HEIGHT-260, PLATFORM) )
        ...
        self._addEnemy( enemy.BoyRobot1(15900,SCREEN_HEIGHT-105, PLATFORM) )
        self._addEnemy( enemy.BoyRobot1(16000,SCREEN_HEIGHT-105, PLATFORM) )
        self._addEnemy( enemy.BoyRobot1(16100,SCREEN_HEIGHT-105, PLATFORM) )
